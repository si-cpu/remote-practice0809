...
public class Warrior extends Java_basic202408.src.oop.inherit.Player {

    int rage; // 전사만이 가지는 속성
    Warrior(String nickName){
        // 모든 생성자에는 super()가 내장되어 있습니다,
        // 자깃 객체가 생성될떄는 부모의 객체도 생성되어야 한다,.
        // 부모의 속성과 기능이 실존하게 되고 , 물려줄수있기 떄문입니다.
        super(nickName);
        this.rage = 100;
    }

    public void dash (){
        System.out.println("돌진스킬을 시작합니다");
    ...
    /*
     ...
     4. 접근제한자는 more public하게!
     */

    @Override
    public void showStatus() {
        super.showStatus(); // super = 부모가 내려주는 내용들

...
public class MethodBasic2 {
    ...
    public static void main(String[] args) {
        ...
        int result = clacRangeTotal(3,96);
        System.out.println("result = " + result);

        System.out.println("오늘뭐먹지? = " + selectRandomFood());

        int[] arr = {10, 30, 50, 70 ,90, 110, 130};
        double avg = calcAverage(arr);
        System.out.println("avg = " + avg);

        double avg2 = calcAverage2(1,2,3,4,566,77,534,465,45,3,34,2,34,34,5243,5345,24,62,432);
